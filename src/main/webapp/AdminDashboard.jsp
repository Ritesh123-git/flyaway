...
<h1>Admin Portal</h1>
	...
	<table style="width:1000px; text-align:center" >
		...
		<%
		try {
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/flyaway", "root", "Ritesh@123");
			Statement statement = con.createStatement();
			ResultSet resultSet = statement.executeQuery("SELECT * FROM flyaway.Booking;");
